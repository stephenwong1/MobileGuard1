...
/**
 * Created by hitma on 2017/11/5. dad
 */
...
public class BlackNumberDao {
    ...
    public  BlackNumberDao(Context context) {
        ...
        if (blackContactInfo.phoneNumber.startsWith("+86")){
            blackContactInfo.phoneNumber = blackContactInfo.phoneNumber.substring(3,blackContactInfo
            .phoneNumber.length());
        }
        ...
        values.put("type", blackContactInfo.contactName2);
    ...
    public List<BlackContactInfo> getPageBlackNumber(int pagenumber,int pagesize){
        ...
        while(cursor.moveToNext()){
            ...
            info.contactName2 = cursor.getString(3);
    ...
    public boolean IsNumberExist(String number) {
        ...
        public int getBlackContactMode(String number){
            ...
            SQLiteDatabase db = blackNumberOpenHelper.getReadableDatabase();
            Cursor cursor = db.query("blacknumber",new String[]{"mode"},"number=?",new String[]
