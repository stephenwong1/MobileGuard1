...
import cn.edu.gdmec.android.mobileguard.m2theftguard.dialog.SetupPaswrodDialog;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void showSetUpPswdDialog(){
        final SetupPaswrodDialog setUpPaswrodDialog = new SetupPaswrodDialog(
                HomeActivity.this);
        setUpPaswrodDialog
                .setCallBack(new SetupPaswrodDialog.MyCallBack(){
                    public void ok() {
                        String firstPwsd = setUpPaswrodDialog.mFirstPWDET.getText().toString().trim();
                        String affirmPwsd = setUpPaswrodDialog.mAffirmET.getText().toString().trim();
                        if(!TextUtils.isEmpty(firstPwsd) && !TextUtils.isEmpty(affirmPwsd)){
                            if(firstPwsd.equals(affirmPwsd)){
                                savePswd(affirmPwsd);
                                setUpPaswrodDialog.dismiss();
                                showInterPswdDialog();
                            }else{
        ...
        setUpPaswrodDialog.setCancelable(true);
        setUpPaswrodDialog.show();
    }
