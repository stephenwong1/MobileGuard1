...
public class TrafficMonitoringActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initData(){
        ...
        long usefflow = mSP.getLong("usedflow",0);
        if(totalflow > 0 & usefflow >= 0){
            float scale = usefflow / totalflow;
            if(scale >0.9){
        ...
        mUsedTV.setText("本月已用：" + Formatter.formatFileSize(this,usefflow));
